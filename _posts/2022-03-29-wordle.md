...
```
## # A tibble: 6 x 13
##   one   two   three four  five  match notmatch c1[,1] c2[,1] c3[,1] c4[,1]
##   <chr> <chr> <chr> <chr> <chr> <chr> <chr>     <dbl>  <dbl>  <dbl>  <dbl>
## 1 c     i     g     a     r     cigar _____         0      0      0      0
## 2 r     e     b     u     t     _____ r____         0      0      0      0
## 3 s     i     s     s     y     _i___ _____         0      0      0      0
## 4 h     u     m     p     h     _____ _____         0      0      0      0
## 5 a     w     a     k     e     _____ a_a__         0      0      0      1
## 6 b     l     u     s     h     _____ _____         0      0      0      0
## # ... with 2 more variables: c5 <dbl[,1]>, score <dbl[,1]>
```
